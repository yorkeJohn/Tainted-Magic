...
public class RecipeVoidsentBlood implements IRecipe
{
    ...
    public ItemStack getCraftingResult (InventoryCrafting inv)
    {
        ...
        for (int i = 0; i < inv.getSizeInventory(); i++)
        {
            if (inv.getStackInSlot(i) != null && inv.getStackInSlot(i).getItem() instanceof ItemArmor) armor = inv
                    .getStackInSlot(i);
            else if (inv.getStackInSlot(i) != null && inv.getStackInSlot(i).getItem() instanceof ItemVoidsentBlood) blood = inv
                    .getStackInSlot(i);
        }
        if (armor != null && blood != null && (armor.getTagCompound() == null || (armor.getTagCompound() != null && !armor
                .getTagCompound().getBoolean("voidtouched"))))
        {
            copy = armor.copy();
