...
public class RecipeRegistry
{
    ...
    public static void initCrafting ()
    {
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ItemRegistry.ItemMaterial, 1, 0),
                new Object[]{ "AAA", "AAA", "AAA", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial, 1, 8) });

        ResearchRegistry.recipes.put("ItemShadowmetalPick",
                GameRegistry.addShapedRecipe(new ItemStack(ItemRegistry.ItemShadowmetalPick),
                        new Object[]{ "AAA", " B ", " B ", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial),
                                Character.valueOf('B'), new ItemStack(Items.stick) }));

        ResearchRegistry.recipes.put("ItemShadowmetalAxe",
                CraftingManager.getInstance().addRecipe(new ItemStack(ItemRegistry.ItemShadowmetalAxe),
                        new Object[]{ "AA", "BA", "B ", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial),
                                Character.valueOf('B'), new ItemStack(Items.stick) }));
        ...
        ResearchRegistry.recipes.put("ItemShadowmetalHoe",
                CraftingManager.getInstance().addRecipe(new ItemStack(ItemRegistry.ItemShadowmetalHoe),
                        new Object[]{ "AA", "B ", "B ", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial),
                                Character.valueOf('B'), new ItemStack(Items.stick) }));

        ResearchRegistry.recipes.put("ItemShadowmetalSword",
                GameRegistry.addShapedRecipe(new ItemStack(ItemRegistry.ItemShadowmetalSword),
                        new Object[]{ "A", "A", "B", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial),
                                Character.valueOf('B'), new ItemStack(Items.stick) }));

        GameRegistry.addRecipe(new ItemStack(ItemRegistry.ItemMaterial, 9),
                new Object[]{ "A", Character.valueOf('A'), new ItemStack(BlockRegistry.BlockShadowmetal) });

        GameRegistry.addRecipe(new ItemStack(ItemRegistry.ItemMaterial, 9, 8),
                new Object[]{ "A", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial, 1, 0) });
    ...
    public static void initInfusion ()
    {
        ...
        ResearchRegistry.recipes.put("ItemFocusMageMace",
                ThaumcraftApi.addInfusionCraftingRecipe("MACEFOCUS", new ItemStack(ItemRegistry.ItemFocusMageMace), 3,
                        ...
                        new ItemStack[]{ new ItemStack(Items.iron_sword), new ItemStack(Items.quartz),
                                ItemApi.getItem("itemShard", 5), new ItemStack(Items.quartz), new ItemStack(Items.iron_sword),
        ...
        ResearchRegistry.recipes.put("ItemSwordCrimson",
                ThaumcraftApi.addInfusionCraftingRecipe("CRIMSONBLADE", new ItemStack(ConfigItems.itemSwordCrimson), 7,
                        ...
                        ItemApi.getItem("itemSwordVoid", 0), new ItemStack[]{ new ItemStack(ItemRegistry.ItemCrimsonBlood),
        ...
        ResearchRegistry.recipes.put("ItemVoidwalkerSash",
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        ItemApi.getItem("itemGirdleRunic", 0),
        ...
        ResearchRegistry.recipes.put("ItemWandRod:0", ThaumcraftApi.addInfusionCraftingRecipe("ROD_warpwood",
                ...
                new ItemStack[]{ new ItemStack(ItemRegistry.ItemMaterial, 1, 9), new ItemStack(ItemRegistry.ItemMaterial),
                        ...
                        ItemApi.getItem("itemZombieBrain", 0), new ItemStack(ItemRegistry.ItemMaterial),
                        new ItemStack(ItemRegistry.ItemMaterial, 1, 3), ItemApi.getItem("itemResource", 16) }));
        ...
        ResearchRegistry.recipes.put("ItemVoidFortressHelmet", ThaumcraftApi.addInfusionCraftingRecipe("VOIDFORTRESS",
                ...
                new AspectList().add(Aspect.METAL, 24).add(Aspect.ARMOR, 16).add(Aspect.MAGIC, 8).add(Aspect.ELDRITCH, 16)
                        .add(Aspect.VOID, 16),
                ItemApi.getItem("itemHelmetVoid", 0),
        ...
        ResearchRegistry.recipes.put("ItemVoidFortressChestplate", ThaumcraftApi.addInfusionCraftingRecipe("VOIDFORTRESS",
                ...
                ItemApi.getItem("itemChestVoid", 0),
                new ItemStack[]{ ItemApi.getItem("itemResource", 16), ItemApi.getItem("itemResource", 16),
        ...
        ResearchRegistry.recipes.put("ItemVoidFortressLeggings", ThaumcraftApi.addInfusionCraftingRecipe("VOIDFORTRESS",
                new ItemStack(ItemRegistry.ItemVoidFortressLeggings), 6,
                new AspectList().add(Aspect.METAL, 24).add(Aspect.ARMOR, 20).add(Aspect.MAGIC, 8).add(Aspect.ELDRITCH, 16)
                        .add(Aspect.VOID, 20),
                ItemApi.getItem("itemLegsVoid", 0),
                new ItemStack[]{ ItemApi.getItem("itemResource", 16), ItemApi.getItem("itemResource", 16),
        ...
        ResearchRegistry.recipes.put("ItemWarpedGoggles",
                ThaumcraftApi.addInfusionCraftingRecipe("WARPEDGOGGLES", new ItemStack(ItemRegistry.ItemWarpedGoggles), 3,
                        new AspectList().add(Aspect.ELDRITCH, 35).add(Aspect.DARKNESS, 12).add(Aspect.MAGIC, 16)
                                .add(Aspect.ARMOR, 8),
                        ItemApi.getItem("itemGoggles", 0), new ItemStack[]{ new ItemStack(ItemRegistry.ItemMaterial, 1, 8),
                                new ItemStack(ConfigItems.itemWispEssence, 1, 32767) }));

        ResearchRegistry.recipes.put("ItemWandCap:0", ThaumcraftApi.addInfusionCraftingRecipe(
                "CAP_shadowmetal", new ItemStack(ItemRegistry.ItemWandCap), 8, new AspectList().add(Aspect.ELDRITCH, 55)
                        .add(Aspect.DARKNESS, 47).add(Aspect.MAGIC, 52).add(Aspect.METAL, 45).add(Aspect.VOID, 55),
                ItemApi.getItem("itemWandCap", 7),
        ...
        ResearchRegistry.recipes.put("ItemFocusTaintSwarm",
                ThaumcraftApi.addInfusionCraftingRecipe(
                        "TAINTFOCUS", new ItemStack(ItemRegistry.ItemFocusTaintSwarm), 4, new AspectList().add(Aspect.TAINT, 45)
                                .add(Aspect.LIFE, 24).add(Aspect.MOTION, 24).add(Aspect.MAGIC, 16).add(Aspect.DEATH, 37),
        ...
        ResearchRegistry.recipes.put("ItemVoidwalkerBoots", ThaumcraftApi.addInfusionCraftingRecipe("VOIDWALKERBOOTS",
                ...
                new ItemStack[]{ new ItemStack(ItemRegistry.ItemMaterial, 1, 10), ItemApi.getItem("itemResource", 16),
                        new ItemStack(ItemRegistry.ItemMaterial, 1, 1), new ItemStack(ItemRegistry.ItemMaterial),
                        new ItemStack(ItemRegistry.ItemMaterial, 1, 1), ItemApi.getItem("itemResource", 16),
                        ItemApi.getItem("itemEldritchObject", 0), ItemApi.getItem("itemResource", 16),
                        new ItemStack(ItemRegistry.ItemMaterial, 1, 1), new ItemStack(ItemRegistry.ItemMaterial),
                        new ItemStack(ItemRegistry.ItemMaterial, 1, 1), ItemApi.getItem("itemResource", 16) }));
        ...
        ResearchRegistry.recipes.put("ItemSalis:0",
                ThaumcraftApi.addInfusionCraftingRecipe("SKYSALT", new ItemStack(ItemRegistry.ItemSalis, 3, 0), 7,
                        ...
                        new ItemStack[]{ new ItemStack(ConfigItems.itemResource, 1, 0),
        ...
        ResearchRegistry.recipes.put("ItemSalis:1",
                ThaumcraftApi.addInfusionCraftingRecipe("TIMESALT", new ItemStack(ItemRegistry.ItemSalis, 3, 1), 7,
                        ...
                        new ItemStack(ConfigItems.itemResource, 1, 14),
                        new ItemStack[]{ new ItemStack(ConfigItems.itemResource, 1, 1), new ItemStack(Items.gold_nugget),
                                new ItemStack(ItemRegistry.ItemMaterial, 1, 11) }));

        ResearchRegistry.recipes.put("ItemThaumicDisassembler",
                ThaumcraftApi.addInfusionCraftingRecipe("THAUMICDISASSEMBLER",
                        new ItemStack(ItemRegistry.ItemThaumicDisassembler), 3,
                        new AspectList()
                                .add(Aspect.METAL, 22).add(Aspect.TOOL, 24).add(Aspect.WEAPON, 14).add(Aspect.MECHANISM, 12),
                        new ItemStack(ItemRegistry.ItemMaterial, 1, 6),
                        new ItemStack[]{ new ItemStack(ItemRegistry.ItemMaterial, 1, 10), ItemApi.getItem("itemPickVoid", 0),
                                ItemApi.getItem("itemResource", 2), ItemApi.getItem("itemShovelVoid", 0),
                                new ItemStack(Items.diamond), ItemApi.getItem("itemSwordVoid", 0),
                                ItemApi.getItem("itemResource", 2), ItemApi.getItem("itemAxeVoid", 0) }));
        ...
        ResearchRegistry.recipes.put("ItemKatanaThaumium:inscription0",
                ThaumcraftApi.addInfusionCraftingRecipe("INSCRIPTIONFIRE", new Object[]{ "inscription", new NBTTagInt(0) }, 8,
                        ...
                        new ItemStack[]{ ItemApi.getItem("itemFocusFire", 0), new ItemStack(Items.coal),
        ...
        ResearchRegistry.recipes.put("ItemVoidmetalGoggles",
                ThaumcraftApi.addInfusionCraftingRecipe("VOIDGOGGLES", new ItemStack(ItemRegistry.ItemVoidmetalGoggles), 5,
                        ...
                        new ItemStack(ItemRegistry.ItemWarpedGoggles, 1, 32767),
    ...
    public static void initArcane ()
    {
        ResearchRegistry.recipes.put("ItemMaterial:2",
                ThaumcraftApi.addShapelessArcaneCraftingRecipe("CRIMSONROBES", new ItemStack(ItemRegistry.ItemMaterial, 1, 2),
                        ...
                        new Object[]{ new ItemStack(ItemRegistry.ItemCrimsonBlood), ItemApi.getItem("itemResource", 7),
        ...
        ResearchRegistry.recipes.put("ItemMaterial:12",
                ThaumcraftApi.addShapelessArcaneCraftingRecipe("WARPTREE", new ItemStack(ItemRegistry.ItemMaterial, 1, 12),
                        ...
                        new Object[]{ new ItemStack(ConfigItems.itemZombieBrain),
                                new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
                                new ItemStack(ConfigItems.itemWispEssence, 1, Short.MAX_VALUE) }));
        ...
        ResearchRegistry.recipes.put("ItemMaterial:6",
                ThaumcraftApi.addArcaneCraftingRecipe("THAUMICDISASSEMBLER", new ItemStack(ItemRegistry.ItemMaterial, 1, 6),
                        ...
                        new Object[]{ "BAB", "A A", "BAB", Character.valueOf('A'), ItemApi.getItem("itemResource", 2),
                                Character.valueOf('B'), ItemApi.getItem("itemResource", 16) }));

        ResearchRegistry.recipes.put("ItemHelmetCultistRobe",
                ThaumcraftApi.addArcaneCraftingRecipe("CRIMSONROBES", ItemApi.getItem("itemHelmetCultistRobe", 0),
                        new AspectList().add(Aspect.FIRE, 5).add(Aspect.ENTROPY, 5),
                        new Object[]{ "AAA", "A A", 'A', new ItemStack(ItemRegistry.ItemMaterial, 1, 2) }));

        ResearchRegistry.recipes.put("ItemChestCultistRobe",
                ThaumcraftApi.addArcaneCraftingRecipe("CRIMSONROBES", ItemApi.getItem("itemChestCultistRobe", 0),
                        new AspectList().add(Aspect.FIRE, 10).add(Aspect.ENTROPY, 10),
                        new Object[]{ "A A", "CAC", "ABA", 'A', new ItemStack(ItemRegistry.ItemMaterial, 1, 2), 'B',
                                new ItemStack(Items.gold_ingot), 'C', new ItemStack(Items.iron_ingot) }));

        ResearchRegistry.recipes.put("ItemLegsCultistRobe",
                ThaumcraftApi.addArcaneCraftingRecipe("CRIMSONROBES", ItemApi.getItem("itemLegsCultistRobe", 0),
                        new AspectList().add(Aspect.FIRE, 8).add(Aspect.ENTROPY, 8),
                        new Object[]{ "ABA", "ACA", "A A", Character.valueOf('A'),
                                new ItemStack(ItemRegistry.ItemMaterial, 1, 2), Character.valueOf('B'),
        ...
        ResearchRegistry.recipes.put("ItemBootsCultist",
                ThaumcraftApi.addArcaneCraftingRecipe("CRIMSONROBES", ItemApi.getItem("itemBootsCultist", 0),
                        new AspectList().add(Aspect.FIRE, 5).add(Aspect.ENTROPY, 5),
                        new Object[]{ "A A", "A A", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial, 1, 2) }));
        ...
        ResearchRegistry.recipes.put("ItemWandRod:1", ThaumcraftApi.addArcaneCraftingRecipe("ROD_warpwood_staff",
                ...
                new AspectList().add(Aspect.ORDER, 120).add(Aspect.WATER, 120).add(Aspect.EARTH, 120).add(Aspect.AIR, 120)
                        .add(Aspect.FIRE, 120).add(Aspect.ENTROPY, 120),
                new Object[]{ "  A", " B ", "B  ", Character.valueOf('A'), new ItemStack(ConfigItems.itemEldritchObject, 1, 3),
                        Character.valueOf('B'), new ItemStack(ItemRegistry.ItemWandRod, 1, 0) }));

        ResearchRegistry.recipes.put("ItemHelmetCultistPlate",
                ThaumcraftApi.addArcaneCraftingRecipe("KNIGHTROBES", ItemApi.getItem("itemHelmetCultistPlate", 0),
                        new AspectList().add(Aspect.EARTH, 5).add(Aspect.FIRE, 5).add(Aspect.ENTROPY, 5),
                        new Object[]{ "ABA", "C C", 'A', new ItemStack(ItemRegistry.ItemMaterial, 1, 7), 'B',
                                new ItemStack(Items.gold_ingot), 'C', new ItemStack(Items.iron_ingot) }));

        ResearchRegistry.recipes.put("ItemChestCultistPlate",
                ThaumcraftApi.addArcaneCraftingRecipe("KNIGHTROBES", ItemApi.getItem("itemChestCultistPlate", 0),
                        new AspectList().add(Aspect.EARTH, 10).add(Aspect.FIRE, 10).add(Aspect.ENTROPY, 10),
                        new Object[]{ "A A", "ABA", "BBB", 'A', new ItemStack(Items.iron_ingot), 'B',
                                new ItemStack(ItemRegistry.ItemMaterial, 1, 7) }));

        ResearchRegistry.recipes.put("ItemLegsCultistPlate",
                ThaumcraftApi.addArcaneCraftingRecipe("KNIGHTROBES", ItemApi.getItem("itemLegsCultistPlate", 0),
                        new AspectList().add(Aspect.EARTH, 8).add(Aspect.FIRE, 8).add(Aspect.ENTROPY, 8),
                        new Object[]{ "ABA", "ACA", " C ", 'A', new ItemStack(Items.iron_ingot), 'B',
                                new ItemStack(Items.gold_ingot), 'C', new ItemStack(ItemRegistry.ItemMaterial, 1, 7) }));
        ...
        ResearchRegistry.recipes.put("ItemHelmetCultistLeaderPlate",
                ThaumcraftApi.addArcaneCraftingRecipe("PRAETORARMOR", new ItemStack(ConfigItems.itemHelmetCultistLeaderPlate),
                        new AspectList().add(Aspect.ORDER, 15).add(Aspect.ENTROPY, 15).add(Aspect.FIRE, 15),
                        new Object[]{ "BCB", "DAD", "BCB", 'A', new ItemStack(ConfigItems.itemHelmetCultistPlate), 'B',
                                new ItemStack(Items.iron_ingot), 'C', new ItemStack(ItemRegistry.ItemMaterial, 1, 7), 'D',
                                new ItemStack(Items.gold_ingot) }));
        ...
        ResearchRegistry.recipes.put("ItemChestCultistLeaderPlate",
                ThaumcraftApi.addArcaneCraftingRecipe("PRAETORARMOR", new ItemStack(ConfigItems.itemChestCultistLeaderPlate),
                        ...
                        new Object[]{ "BBB", "CAC", "CDC", 'A', new ItemStack(ConfigItems.itemChestCultistPlate), 'B',
                                new ItemStack(Items.iron_ingot), 'C', new ItemStack(ItemRegistry.ItemMaterial, 1, 7), 'D',
                                new ItemStack(Items.gold_ingot) }));
        ...
        ResearchRegistry.recipes.put("ItemLegsCultistLeaderPlate",
                ThaumcraftApi.addArcaneCraftingRecipe("PRAETORARMOR", new ItemStack(ConfigItems.itemLegsCultistLeaderPlate),
                        new AspectList().add(Aspect.ORDER, 20).add(Aspect.ENTROPY, 20).add(Aspect.FIRE, 20),
                        new Object[]{ "CDC", "BAB", "BCB", 'A', new ItemStack(ConfigItems.itemLegsCultistPlate), 'B',
        ...
        ResearchRegistry.recipes.put("ItemMaterial:1",
                ThaumcraftApi.addArcaneCraftingRecipe("SHADOWCLOTH", new ItemStack(ItemRegistry.ItemMaterial, 1, 1),
                        ...
                        new Object[]{ "CAC", "ABA", "CAC", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial),
                                Character.valueOf('B'), ItemApi.getItem("itemResource", 7), Character.valueOf('C'),
        ...
        ResearchRegistry.recipes.put("ItemMagicFunguar",
                ThaumcraftApi.addShapelessArcaneCraftingRecipe("MAGICFUNGUAR", new ItemStack(ItemRegistry.ItemMagicFunguar),
                        TaintedMagicHelper.getPrimals(1), new Object[]{ new ItemStack(ConfigBlocks.blockCustomPlant, 1, 5),
                                new ItemStack(ConfigItems.itemShard, 1, 32767), Items.glowstone_dust }));

        ResearchRegistry.recipes.put("ItemHollowDagger", ThaumcraftApi.addArcaneCraftingRecipe("HOLLOWDAGGER",
                new ItemStack(ItemRegistry.ItemHollowDagger), new AspectList().add(Aspect.ENTROPY, 85),
                new Object[]{ "  A", "EBD", "C  ", Character.valueOf('A'), new ItemStack(ConfigItems.itemWandRod, 1, 7),
                        Character.valueOf('B'), new ItemStack(ConfigBlocks.blockMagicalLog, 1, 0), Character.valueOf('C'),
                        Items.stick, Character.valueOf('D'), ConfigItems.itemNugget, Character.valueOf('E'), Items.string }));
        ...
        ResearchRegistry.recipes.put("ItemWandCap:1",
                ThaumcraftApi.addArcaneCraftingRecipe(
                        ...
                        new Object[]{ "AAA", "A A", Character.valueOf('A'), ItemApi.getItem("itemResource", 7) }));
        ...
        ResearchRegistry.recipes.put("ItemWandCap:3",
                ThaumcraftApi.addArcaneCraftingRecipe("CAP_shadowcloth", new ItemStack(ItemRegistry.ItemWandCap, 1, 3),
                        new AspectList().add(Aspect.EARTH, 55).add(Aspect.FIRE, 55).add(Aspect.ENTROPY, 55).add(Aspect.ORDER,
                                55),
                        new Object[]{ "AAA", "ABA", Character.valueOf('A'), new ItemStack(ItemRegistry.ItemMaterial, 1, 1),
                                Character.valueOf('B'), ItemApi.getItem("itemResource", 14) }));
        ...
        ResearchRegistry.recipes.put("ItemFocusVisShard",
                ThaumcraftApi.addArcaneCraftingRecipe("FOCUSSHARD", new ItemStack(ItemRegistry.ItemFocusVisShard),
                        new AspectList().add(Aspect.AIR, 46).add(Aspect.ENTROPY, 38).add(Aspect.ORDER, 22),
                        new Object[]{ "BDC", "DAD", "CDB", 'A', new ItemStack(ConfigItems.itemResource, 1, 3), 'B',
                                new ItemStack(ConfigItems.itemShard, 1, 6), 'C', new ItemStack(ItemRegistry.ItemMaterial, 1, 4),
                                'D', new ItemStack(ConfigItems.itemWispEssence, 1, 32767) }));
        ...
        ResearchRegistry.recipes.put("ItemFocusLumos",
                ThaumcraftApi.addArcaneCraftingRecipe("FOCUSLUMOS", new ItemStack(ItemRegistry.ItemFocusLumos),
                        new AspectList().add(Aspect.AIR, 52).add(Aspect.FIRE, 56).add(Aspect.ORDER, 28),
                        new Object[]{ "BDC", "DAD", "CDB", 'A', new ItemStack(ConfigItems.itemResource, 1, 3), 'B',
                                new ItemStack(ConfigItems.itemResource, 1, 1), 'C', new ItemStack(ConfigItems.itemShard, 1, 6),
        ...
        ResearchRegistry.recipes.put("ItemVoidsentBlood", ThaumcraftApi.addArcaneCraftingRecipe("VOIDSENTBLOOD",
                new ItemStack(ItemRegistry.ItemVoidsentBlood), new AspectList().add(Aspect.ORDER, 35).add(Aspect.ENTROPY, 25),
                new Object[]{ "BDB", "CAC", "BCB", 'A', new ItemStack(ItemRegistry.ItemCrimsonBlood), 'B',
                        new ItemStack(ConfigItems.itemResource, 1, 17), 'C', new ItemStack(ConfigItems.itemResource, 1, 14),
                        'D', new ItemStack(ItemRegistry.ItemMaterial, 1, 10) }));
    }
    ...
    public static void initCrucible ()
    {
        ResearchRegistry.recipes.put("ItemMaterial:3",
                ThaumcraftApi.addCrucibleRecipe("UNBALANCEDSHARDS", new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
                        ItemApi.getItem("itemShard", 6), new AspectList().merge(Aspect.ELDRITCH, 4)));
        ResearchRegistry.recipes.put("ItemMaterial:4",
                ThaumcraftApi.addCrucibleRecipe("UNBALANCEDSHARDS", new ItemStack(ItemRegistry.ItemMaterial, 1, 4),
                        ItemApi.getItem("itemShard", 6), new AspectList().merge(Aspect.TAINT, 4)));
