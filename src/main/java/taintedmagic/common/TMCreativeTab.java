...
public class TMCreativeTab extends CreativeTabs
{
    ...
    public void displayAllReleventItems (List list)
    {
        ...
        if (list != null) list.add(0, stack);

        ItemStack stack2 = stack.copy();
        ItemWandCasting wand2 = (ItemWandCasting) stack2.getItem();
        ...
        if (list != null) list.add(1, stack2);

        ItemStack stack3 = stack2.copy();
        ItemWandCasting wand3 = (ItemWandCasting) stack3.getItem();
        ...
        if (list != null) list.add(2, stack3);
    }
